...
export default class JoinPublicGroupRequestScreen extends Component {
  ...
  getData = async () => {
    ...
    try {
      if (this.props.route.params.groupid.admin_id.includes(this.props.route.params.groupid.currentUser)) {
        ...
        const response = await fetch("http://192.168.0.102:3000/groups/getAllGroupRequest", requestOptions);
  ...
  confirmRequest = async (item) => {
    ...
    try {
      ...
      const response = await fetch("http://192.168.0.102:3000/groups/confirmGroupRequest", requestOptions);
      //const json = await response.json();
      //  console.log("Error ",json)
  ...
  RemoveRequest = async (item) => {
    ...
    try {
      ...
      const response = await fetch("http://192.168.0.102:3000/groups/removeGroupRequest", requestOptions);
      //const json = await response.json();
      //  console.log("Error ",json)
