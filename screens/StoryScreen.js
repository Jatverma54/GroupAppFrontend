...
const StoryScreen = ({ navigation }) => {
  ...
  return (
    error != null ?
     ...
     {'\n'}<Text style={{fontWeight: 'bold'}}>Story behind GroupApp:</Text>{'\n'}My father is battling with multiple myeloma from past one year. Fortunate enough, he is doing good after 1 year of rigorous medical procedures, strong committment and patience. While undergoing treatment, we always used to scroll the web groups for guidance on different healthcare groups for our open questions.{'\n'}Unfortunately, due to less information or less participation of certified healthcare providers on those groups, we used to feel helpless in different scenarios where there was no one to guide us.
