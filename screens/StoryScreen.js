...
const StoryScreen = ({ navigation }) => {
  ...
  return (
    error != null ?
     ...
     Also, we would like to request from bottom of my heart to different medical service providers to join different medical groups created by people on various topics on GroupApp and lets help everyone to acheive a better life.
     {'\n'}{'\n'}<Text style={{ fontWeight: 'bold' }}>Heartiest thanks to all the Medical workers.There is a reason why you get compared with god,{'\n'}{'\n'}Best Regards,{'\n'}GroupHelpMe Team</Text>
          </Text>
