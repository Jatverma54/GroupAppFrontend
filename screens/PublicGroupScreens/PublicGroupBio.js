      ...
      <View style={styles.container}>
          ...
          <View style={styles.body}>
            ...
            <TouchableOpacity style={styles.buttonContainer}>
                <Text style={{fontWeight:"bold",width:"100%",marginLeft:180}}>Join Group</Text>  
              </TouchableOpacity> 
              <Text style={styles.description}>Various educators teach rules governing the length of paragraphs. They may say that a paragraph should be 100 to 200 words long, or be no more than five or six sentences. But a good paragraph should not be measured in characters, words, or sentences. The true measure of your paragraphs should be ideas.</Text>
            </View>
        </View>
      </View>
    );
