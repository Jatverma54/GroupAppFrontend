...
var id= this.props.routeData!==undefined?this.props.routeData._id:this.props.route.params._id
      const response = await fetch("http://192.168.0.107:3000/groupPost/getComments/" +id, requestOptions);
  ...
  Likes = async (data) => {
    try {
      ...
      const response = await fetch("http://192.168.0.107:3000/groupPost/Commentslike", requestOptions);
  ...
  send = async () => {
    if (this.state.msg.length > 0) {
      ...
      try {
        ...
        const response = await fetch("http://192.168.0.107:3000/groupPost/createNewComment", requestOptions);
  ...
  deletearray = async (item) => {
    ...
    try {
      ...
      const response = await fetch("http://192.168.0.107:3000/groupPost/deleteComment", requestOptions
